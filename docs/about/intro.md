...
- RESTful API documentation and developer portals
- Data science and AI platform documentation (KDB.AI, PyKX)
- Fintech and financial infrastructure documentation
- UX writing and in-product content
- Docs-as-code workflows and toolchain setup
- Cross-functional collaboration with engineering, product, legal, and compliance
