(function () {
  ...
  var TERMS = [
    ...
    { key: 'colo', term: 'colo', definition: 'Colocation facility: a third-party data centre where an organisation rents space, power, and connectivity for its own servers and network equipment.' },
