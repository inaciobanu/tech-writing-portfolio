...
| Proven Techniques for Technical Communication | Codecademy |
| Core DevOps Skills: Continuous Principles | Codecademy |
| Claude Code 101 | Anthropic |
| Introduction to Claude Artifacts | Codecademy |
| Level 2 Certificate in Understanding Coding | NCFE |
